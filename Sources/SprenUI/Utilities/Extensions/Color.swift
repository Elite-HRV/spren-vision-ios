...
extension Color {
    ...
    static let sprenUIColor1 = SprenUI.config.color1 ?? sprenPink
    static let sprenUIColor2 = SprenUI.config.color2 ?? sprenPurple
    ...
    static let sprenBodyCompBackgroundDark = Color(red: 0.052, green: 0.052, blue: 0.059)
    ...
    static let sprenBodyCompGreenDark = Color(red: 0.051, green: 0.757, blue: 0.545)
    
    static let sprenBodyCompGrayLight = Color(red: 0.486, green: 0.490, blue: 0.580)
    static let sprenBodyCompGrayDark = Color(red: 0.486, green: 0.490, blue: 0.580)
    ...
    static let sprenBodyCompPurpleDark = Color(red: 0.322, green: 0.275, blue: 0.659)
    
    static let sprenBodyCompBlack20Light = Color(red: 0, green: 0, blue: 0, opacity: 0.2)
    static let sprenBodyCompBlack20Dark = Color(red: 1, green: 1, blue: 1, opacity: 0.8)
    
    static let sprenBodyCompLightGray2Light = Color(red: 0.584, green: 0.600, blue: 0.643)
    static let sprenBodyCompLightGray2Dark = Color(red: 0.584, green: 0.600, blue: 0.643)
    
    static let sprenBodyCompLightGray10Light = Color(red: 0.098, green: 0.098, blue: 0.141, opacity: 0.1)
    static let sprenBodyCompLightGray10Dark = Color(red: 1, green: 1, blue: 1, opacity: 0.81)
