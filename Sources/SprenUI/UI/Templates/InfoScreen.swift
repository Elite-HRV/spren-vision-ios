            ...
            VStack(alignment: .leading, spacing: 0) {
                ...
                if(type == "hr"){
                    InfoImprovements(
                        ...
                        items: [InfoImprovementsItem(icon: "Cardio", title: "Stay active", text: "Avoid being sedentary and exercise appropriately to maintain a stronger heart muscle. The American Heart Association recommends at least 150 minutes per week of moderate-intensity aerobic activity or 75 minutes per week of vigorous activity."),InfoImprovementsItem(icon: "Weight", title: "Maintain a healthy weight", text: "Excess fat and not enough muscle mass force your heart to work harder to deliver blood to your body. Maintaining a healthy weight with good nutrition and regular exercise gives your heart a break."),InfoImprovementsItem(icon: "Bottle", title: "Stay hydrated", text: "Hydration is important for maintaining a healthy blood volume needed to deliver oxygen and nutrients to your body. Dehydration can cause your blood to thicken, which makes your heart work harder."),InfoImprovementsItem(icon: "Sleep", title: "Sleep well and consistently", text: "Your heart rate lowers while you are sleeping. Consistent, quality sleep gives your heart a needed break to recover from the day’s stressors."),InfoImprovementsItem(icon: "Stress", title: "Better manage stress", text: "Anxiety and stress can elevate your heart rate. Listen to your body and practice mindfulness and breathing exercises to combat stress."),InfoImprovementsItem(icon: "noSmoking", title: "Avoid caffeine and nicotine", text: "Caffeine and cigarettes can increase your heart rate and cutting back can lower your resting heart rate.")]
                    )
                }
