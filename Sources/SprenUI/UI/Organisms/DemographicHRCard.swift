...
struct DemographicHRCard: View {
    ...
    var body: some View {
        ...
        VStack {
            VStack {
                HStack {
                    ResultCircle(value: "\(String(format: "%.0f", value))", unit: nil, color: Color(colors[colorIndex], bundle: .module))
                ...
                VStack {
                    DemographicRow(color: Color("DemographicGreen", bundle: .module), text: "Excellent", range: data[0])
                    DemographicRow(color: Color("DemographicMediumGreen", bundle: .module), text: "Very Good", range: data[1])
                    DemographicRow(color: Color("DemographicLightGreen", bundle: .module), text: "Better than Average", range: data[2])
                    DemographicRow(color: Color("DemographicYellow", bundle: .module), text: "Average", range: data[3])
                    DemographicRow(color: Color("DemographicOrange", bundle: .module), text: "Below Average", range: data[4])
                    DemographicRow(color: Color("DemographicRed", bundle: .module), text: "Poor", range: data[5])
                }
            }
            .sprenUIPadding()
